...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="margin:20px auto">
    ...
    <tr>
        ...
        <td valign="top" style="padding-bottom:20px; color:#363636; font-size: 20px; line-height:1.3; text-align:left; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">
            <strong>cubeCTMS ${projectTitle} User Registration</strong>
        </td>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
    </tr>
    <tr>
        ...
        <td height="70" valign="top" style="padding-bottom:26px; color:#212121; line-height:1.86; font-size:14px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">
            ...
            You have been registered as a user for project ${projectTitle} clinical trial management system(cubeCTMS).<br />
    ...
    <tr>
        ...
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top :15px; margin-bottom : 25px;">
                ...
                <tr>
                    <td bgcolor="#f5f5f5" style="width:25%; padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Access URL</td>
                    <td bgcolor="#f5f5f5" style="width:75%; padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;"><a href="${systemURL}" style="color:#54aaef; text-decoration:underline; font-size:14px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">${systemURL}</a></td>
                </tr>
                <tr>
        ...
        <td style="text-align:left;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td colspan="2" style="padding-top:150px; padding-bottom:16px; font-size:14px; font-weight:bold; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif; color:#363636">Question</td>
                </tr>
                <tr>
                    <td width="24" style="font-size:0; line-height:0;">&nbsp;</td>
