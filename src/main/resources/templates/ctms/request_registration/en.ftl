...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="margin:20px auto">
    ...
    <tr>
        ...
        <td height="70" valign="top" style="padding-bottom:26px; color:#212121; line-height:1.86; font-size:14px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">
            ...
            Please click the below URL to complete your user registration to ${sponsorName}'s cubeCTMS.
        </td>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
    </tr>
    <tr>
        ...
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top :15px; margin-bottom : 25px;">
                ...
                <tr>
                    <td bgcolor="#f5f5f5" style="width:30%; padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">URL</td>
                    <td bgcolor="#f5f5f5" style="width:70%; padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;"><a href="${systemURL}" style="color:#54aaef; text-decoration:underline; font-size:14px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Go to page</a></td>
                </tr>
            </table>
        </td>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
    ...
    <tr>
        ...
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top:15px;">
                ...
                <tr>
                    <td bgcolor="#f5f5f5" style="width:30%; padding:10px; color:#363636; font-size:12px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Personal Password</td>
                    <td bgcolor="#f5f5f5" style="width:70%; padding:10px; color:#363636; font-size:12px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Passwords must include letters and number and be of at least 8 characters</td>
                </tr>
                <tr>
                    <td bgcolor="#ffffff" style="padding:10px; color:#363636; font-size:12px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Password Expiration</td>
