...
<#-- @ftlvariable name="expiredMinutes" type="java.lang.String" -->
...
<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="margin:20px auto">
    ...
    <tr>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
        <td valign="top" style="padding-bottom:20px; color:#363636; font-size: 20px; line-height:1.3; letter-spacing:-0.5px; text-align:left; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">
            <strong>${sponsorName}(cubeCTMS) Password configuration</strong>
        </td>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
    </tr>
    <tr>
        ...
        <td height="70" valign="top" style="padding-bottom:26px; color:#212121; line-height:1.86; font-size:14px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">
            In order to reset your password, please click the link.<br />
            This link will be expired after ${expiredMinutes?default('30')} minutes.<br />
            You can ignore this email if you will not change your password.
        </td>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
    </tr>
    <tr>
        ...
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top :15px; margin-bottom : 25px;">
                ...
                <tr>
                    <td bgcolor="#f5f5f5" style="width:35%; padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Password configuration</td>
                    <td bgcolor="#f5f5f5" style="width:65%; padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;"><a href="${systemURL}" style="color:#54aaef; text-decoration:underline; font-size:14px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Go to page</a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td bgcolor="#f5f5f5" style="padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">Sponsor</td>
                    <td bgcolor="#f5f5f5" style="padding:6px 0; color:#363636; font-size:14px; padding-left:24px; font-family: 'Noto Sans KR', Arial, Helvetica, sans-serif;">${sponsorName}</td>
                </tr>
            </table>
        </td>
        <td width="56" style="font-size:0; line-height:0;">&nbsp;</td>
